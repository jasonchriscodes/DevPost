  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2 justify-center items-center mb-2">
        <h3 className="font-semibold text-2xl">Sign Up Form</h3>
      ...
      <div>
        <Label htmlFor="first_name" className="dark:text-[#97989F]">
          First Name
        </Label>
        <Input
          type="text"
      ...
      <div>
        <Label htmlFor="last_name" className="dark:text-[#97989F]">
          Last Name
        </Label>
        <Input
          type="text"
      ...
      <div>
        <Label htmlFor="confirmPassword" className="dark:text-[#97989F]">
          Confirm Password
        </Label>
        <Input
          type="password"
      ...
      <div className="w-full flex items-center justify-center flex-col my-4">
        ...
        <p className="text-[14px] mt-2">
          ...
          <Link to="/signin" className="text-[#4B6BFB] font-semibold">
            Sign In
          </Link>
        </p>
      </div>
